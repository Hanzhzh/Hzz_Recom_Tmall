...
-- 用户行为特征
create table if not exists user_click_ads (
    user_id string,
...
INSERT OVERWRITE TABLE user_click_ads PARTITION (ds=${bizdate}) 
select user_id
...
create table if not exists user_collect_ads (
    user_id string,
...
INSERT OVERWRITE TABLE user_collect_ads PARTITION (ds=${bizdate})
select user_id
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), item_id, null))
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), brand_id, null))
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), seller_id, null))
...
create table if not exists user_cart_ads (
    user_id string,
...
INSERT OVERWRITE TABLE user_cart_ads PARTITION (ds=${bizdate}) -- 用户点击行为特征
select user_id
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), item_id, null))
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), brand_id, null))
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), seller_id, null))
...
create table if not exists user_alipay_ads (
    user_id string,
...
INSERT OVERWRITE TABLE user_alipay_ads PARTITION (ds=${bizdate}) -- 用户点击行为特征
select user_id
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), item_id, null))
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), brand_id, null))
    ,count(distinct if(ds>=to_char(dateadd(to_date(${bizdate}, 'yyyymmdd'),-3, 'dd'),'yyyymmdd'), seller_id, null))
