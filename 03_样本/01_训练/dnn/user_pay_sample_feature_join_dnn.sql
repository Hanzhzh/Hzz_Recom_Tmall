...
select 
    ...
    t1.brand_id, 
    t1.label, 
    concat('b_',t1.brand_id) as target_brand_id

    ,if(t2.brand_id_seq is null, 'clkb_seq_null', t2.brand_id_seq) as clk_brand_seq
    ,if(t3.brand_id_seq is null, 'cltb_seq_null', t3.brand_id_seq) as clt_brand_seq 
    ,if(t4.brand_id_seq is null, 'payb_seq_null', t4.brand_id_seq) as pay_brand_seq 
    ,if(t5.cate2_seq is null, 'clkc_seq_null', t5.cate2_seq) as clk_cate_seq
    ,if(t6.cate2_seq is null, 'cltc_seq_null', t6.cate2_seq) as clt_cate_seq
    ,if(t7.cate2_seq is null, 'payc_seq_null', t7.cate2_seq) as pay_cate_seq
    ,if(t8.user_id is null, 'user_click_null', 
    concat(
    ...
    ,if(t9.user_id is null, 'user_clt_null',
    concat(
    ...
    ,if(t10.user_id is null, 'user_cart_null',
    concat(
    ...
    ,if(t11.user_id is null, 'user_pay_null',
    concat(
    ...
    ,if(t12.brand_id is null, 'brand_stat_null',
    concat(
    ...
    ,if(t13.user_id is null, 'uc2_null',
    concat(
        concat('uc2_clk_item_90d','_',if(t14.click_item_90d is null, 'null', cast(log(2,t14.click_item_90d+1) as bigint))),',',
        concat('uc2_clk_item_60d','_',if(t14.click_item_60d is null, 'null', cast(log(2,t14.click_item_60d+1) as bigint))),',',
        concat('uc2_clk_item_30d','_',if(t14.click_item_30d is null, 'null', cast(log(2,t14.click_item_30d+1) as bigint))),',',
        concat('uc2_clk_item_15d','_',if(t14.click_item_15d is null, 'null', cast(log(2,t14.click_item_15d+1) as bigint))),',',
        concat('uc2_clk_item_7d','_',if(t14.click_item_7d is null, 'null', cast(log(2,t14.click_item_7d+1) as bigint))),',',
        concat('uc2_clk_item_3d','_',if(t14.click_item_3d is null, 'null', cast(log(2,t14.click_item_3d+1) as bigint))),',',
        concat('uc2_clk_item_1d','_',if(t14.click_item_1d is null, 'null', cast(log(2,t14.click_item_1d+1) as bigint))),',',
        concat('uc2_clk_num_90d','_',if(t14.click_num_90d is null, 'null', cast(log(2,t14.click_num_90d+1) as bigint))),',',
        concat('uc2_clk_num_60d','_',if(t14.click_num_60d is null, 'null', cast(log(2,t14.click_num_60d+1) as bigint))),',',
        concat('uc2_clk_num_30d','_',if(t14.click_num_30d is null, 'null', cast(log(2,t14.click_num_30d+1) as bigint))),',',
        concat('uc2_clk_num_15d','_',if(t14.click_num_15d is null, 'null', cast(log(2,t14.click_num_15d+1) as bigint))),',',
        concat('uc2_clk_num_7d','_',if(t14.click_num_7d is null, 'null', cast(log(2,t14.click_num_7d+1) as bigint))),',',
        concat('uc2_clk_num_3d','_',if(t14.click_num_3d is null, 'null', cast(log(2,t14.click_num_3d+1) as bigint))),',',
        concat('uc2_clk_num_1d','_',if(t14.click_num_1d is null, 'null', cast(log(2,t14.click_num_1d+1) as bigint))),',',
        concat('uc2_clk_day_90d','_',if(t14.click_day_90d is null, 'null', cast(log(2,t14.click_day_90d+1) as bigint))),',',
        concat('uc2_clk_day_60d','_',if(t14.click_day_60d is null, 'null', cast(log(2,t14.click_day_60d+1) as bigint))),',',
        concat('uc2_clk_day_30d','_',if(t14.click_day_30d is null, 'null', cast(log(2,t14.click_day_30d+1) as bigint))),',',
        concat('uc2_clk_day_15d','_',if(t14.click_day_15d is null, 'null', cast(log(2,t14.click_day_15d+1) as bigint))),',',
        concat('uc2_clk_day_7d','_',if(t14.click_day_7d is null, 'null', cast(log(2,t14.click_day_7d+1) as bigint))),',',
        concat('uc2_clk_day_3d','_',if(t14.click_day_3d is null, 'null', cast(log(2,t14.click_day_3d+1) as bigint))),',',
        concat('uc2_clk_day_1d','_',if(t14.click_day_1d is null, 'null', cast(log(2,t14.click_day_1d+1) as bigint))),',',
        concat('uc2_clt_item_90d','_',if(t14.collect_item_90d is null, 'null', cast(log(2,t14.collect_item_90d+1) as bigint))),',',
        concat('uc2_clt_item_60d','_',if(t14.collect_item_60d is null, 'null', cast(log(2,t14.collect_item_60d+1) as bigint))),',',
        concat('uc2_clt_item_30d','_',if(t14.collect_item_30d is null, 'null', cast(log(2,t14.collect_item_30d+1) as bigint))),',',
        concat('uc2_clt_item_15d','_',if(t14.collect_item_15d is null, 'null', cast(log(2,t14.collect_item_15d+1) as bigint))),',',
        concat('uc2_clt_item_7d','_',if(t14.collect_item_7d is null, 'null', cast(log(2,t14.collect_item_7d+1) as bigint))),',',
        concat('uc2_clt_item_3d','_',if(t14.collect_item_3d is null, 'null', cast(log(2,t14.collect_item_3d+1) as bigint))),',',
        concat('uc2_clt_item_1d','_',if(t14.collect_item_1d is null, 'null', cast(log(2,t14.collect_item_1d+1) as bigint))),',',
        concat('uc2_cart_item_90d','_',if(t14.cart_item_90d is null, 'null', cast(log(2,t14.cart_item_90d+1) as bigint))),',',
        concat('uc2_cart_item_60d','_',if(t14.cart_item_60d is null, 'null', cast(log(2,t14.cart_item_60d+1) as bigint))),',',
        concat('uc2_cart_item_30d','_',if(t14.cart_item_30d is null, 'null', cast(log(2,t14.cart_item_30d+1) as bigint))),',',
        concat('uc2_cart_item_15d','_',if(t14.cart_item_15d is null, 'null', cast(log(2,t14.cart_item_15d+1) as bigint))),',',
        concat('uc2_cart_item_7d','_',if(t14.cart_item_7d is null, 'null', cast(log(2,t14.cart_item_7d+1) as bigint))),',',
        concat('uc2_cart_item_3d','_',if(t14.cart_item_3d is null, 'null', cast(log(2,t14.cart_item_3d+1) as bigint))),',',
        concat('uc2_cart_item_1d','_',if(t14.cart_item_1d is null, 'null', cast(log(2,t14.cart_item_1d+1) as bigint))),',',
        concat('uc2_cart_num_90d','_',if(t14.cart_num_90d is null, 'null', cast(log(2,t14.cart_num_90d+1) as bigint))),',',
        concat('uc2_cart_num_60d','_',if(t14.cart_num_60d is null, 'null', cast(log(2,t14.cart_num_60d+1) as bigint))),',',
        concat('uc2_cart_num_30d','_',if(t14.cart_num_30d is null, 'null', cast(log(2,t14.cart_num_30d+1) as bigint))),',',
        concat('uc2_cart_num_15d','_',if(t14.cart_num_15d is null, 'null', cast(log(2,t14.cart_num_15d+1) as bigint))),',',
        concat('uc2_cart_num_7d','_',if(t14.cart_num_7d is null, 'null', cast(log(2,t14.cart_num_7d+1) as bigint))),',',
        concat('uc2_cart_num_3d','_',if(t14.cart_num_3d is null, 'null', cast(log(2,t14.cart_num_3d+1) as bigint))),',',
        concat('uc2_cart_num_1d','_',if(t14.cart_num_1d is null, 'null', cast(log(2,t14.cart_num_1d+1) as bigint))),',',
        concat('uc2_pay_item_90d','_',if(t14.pay_item_90d is null, 'null', cast(log(2,t14.pay_item_90d+1) as bigint))),',',
        concat('uc2_pay_item_60d','_',if(t14.pay_item_60d is null, 'null', cast(log(2,t14.pay_item_60d+1) as bigint))),',',
        concat('uc2_pay_item_30d','_',if(t14.pay_item_30d is null, 'null', cast(log(2,t14.pay_item_30d+1) as bigint))),',',
        concat('uc2_pay_item_15d','_',if(t14.pay_item_15d is null, 'null', cast(log(2,t14.pay_item_15d+1) as bigint))),',',
        concat('uc2_pay_item_7d','_',if(t14.pay_item_7d is null, 'null', cast(log(2,t14.pay_item_7d+1) as bigint))),',',
        concat('uc2_pay_item_3d','_',if(t14.pay_item_3d is null, 'null', cast(log(2,t14.pay_item_3d+1) as bigint))),',',
        concat('uc2_pay_item_1d','_',if(t14.pay_item_1d is null, 'null', cast(log(2,t14.pay_item_1d+1) as bigint))),',',
        concat('uc2_pay_num_90d','_',if(t14.pay_num_90d is null, 'null', cast(log(2,t14.pay_num_90d+1) as bigint))),',',
        concat('uc2_pay_num_60d','_',if(t14.pay_num_60d is null, 'null', cast(log(2,t14.pay_num_60d+1) as bigint))),',',
        concat('uc2_pay_num_30d','_',if(t14.pay_num_30d is null, 'null', cast(log(2,t14.pay_num_30d+1) as bigint))),',',
        concat('uc2_pay_num_15d','_',if(t14.pay_num_15d is null, 'null', cast(log(2,t14.pay_num_15d+1) as bigint))),',',
        concat('uc2_pay_num_7d','_',if(t14.pay_num_7d is null, 'null', cast(log(2,t14.pay_num_7d+1) as bigint))),',',
        concat('uc2_pay_num_3d','_',if(t14.pay_num_3d is null, 'null', cast(log(2,t14.pay_num_3d+1) as bigint))),',',
        concat('uc2_pay_num_1d','_',if(t14.pay_num_1d is null, 'null', cast(log(2,t14.pay_num_1d+1) as bigint)))
    )) as user_cate2_cross_feature
    ,if(t14.user_id is null, 'ub_null',
       concat(
        concat('uc2_clk_item_90d','_',if(t14.click_item_90d is null, 'null', cast(log(2,t14.click_item_90d+1) as bigint))),',',
        concat('uc2_clk_item_60d','_',if(t14.click_item_60d is null, 'null', cast(log(2,t14.click_item_60d+1) as bigint))),',',
        concat('uc2_clk_item_30d','_',if(t14.click_item_30d is null, 'null', cast(log(2,t14.click_item_30d+1) as bigint))),',',
...
left join(
    select *
    FROM user_alipay_brand_seq_feature
    where ds=${bizdate}
)t4 on t1.user_id=t4.user_id
left join(
    select *
    from user_click_cate2_seq_feature
    where ds=${bizdate}
)t5 on t1.user_id=t5.user_id
left join(
    select *
    from user_collect_cate2_seq_feature
    where ds=${bizdate}
)t6 on t1.user_id=t6.user_id
left join(
    select *
    from user_alipay_cate2_seq_feature
    where ds=${bizdate}
...
where (t2.brand_id_seq is not null or t3.brand_id_seq is not null or t4.brand_id_seq is not null or
    t5.cate2_seq is not null or t6.cate2_seq is not null or t7.cate2_seq is not null or
...
-- SELECT count(*) FROM user_pay_sample_feature_join_dnn WHERE ds = '20130701';
